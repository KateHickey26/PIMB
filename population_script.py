...
def populate():
    ...
    speakers = [{'name':'Adam Scott','desc': 'Are you looking for someone to bring some flair to your next corporate event? Look no further!','rate': 3, 'Tags':['Corporate Events'], 'email':'lucy@munroesmotivators.com','phone':'0563 456 66','company':'Munroes Motivators','hourlyrate':'£500','twitter':'https://twitter.com/home', 'youtube':'https://www.youtube.com/'},
    {'name':'Ben Halpert','desc': 'I specialise in convincing unemployed people to stop looking for a job, and start giving me money (taken bi-monthly) to help them acheive their dreams!!','rate': 4,'Tags':['','Job Fairs'], 'email':'hnelson@nelsontalent.com','phone':'0173 466 56','company':'Nelson Talent','hourlyrate':'£250','twitter':'https://twitter.com/home','youtube':'https://www.youtube.com/'},
    ...
    ,'rate': 5, 'Tags':['Wellness Retreats','Hotel Conference Room Fillers','Lonely Hearts Conventions'], 'email':'grahem@ghmanagement.com','phone':'0123 456 56','company':'GH Management','hourlyrate':'£300','twitter':'https://twitter.com/home','youtube':'https://www.youtube.com/'},
    ...
    for s in speakers:
        add_speakers(s['name'], s['desc'],s['Tags'],s['email'],s['phone'],s['company'],s['hourlyrate'],s['twitter'],s['youtube'])
...
def add_speakers(name, desc, tags , email, phone, company, hourlyrate, twitter, youtube):
    try:
